...
/**
 * La classe {@code Member} représente un membre d'un système où les
 * utilisateurs possèdent un login, un mot de passe, et un profil. Cette classe
 * permet de gérer les informations de base d'un utilisateur.
 */
public class Member {
	/**
	 * Le login du membre.
	...
	/**
	 * Constructeur pour créer un nouveau membre avec un login, un mot de passe et
	 * un profil spécifiés.
	 * 
	 * @param login    Le login du nouveau membre. Ne doit pas être {@code null}.
	 * @param password Le mot de passe du nouveau membre. Ne doit pas être
	 *                 {@code null}.
	...
	public void checkParameters() throws BadEntryException {
		...
		if (this.password.strip().length() < 4) {
			throw new BadEntryException("The password is smaller than 4");
		}
